...
void prinr(int *cont, int *contimpar, int *vet, int *vetimpar) // imprime os vetores
{
	int i=0;
...
int fvet(int *vet, int *pcont) //preenche a tabela 1
{
	int i,num;
...
int cont=0,vet[100], vetimpar[100];
	...
	print(&cont, &contimpar, vet, vetimpar);
